...
rsync scons squashfs-tools subversion swig texinfo uglifyjs upx-ucl unzip vim wget xmlto xxd zlib1g-dev rename
...
master)
  ...
  # 删除重复插件（LEDE）
  find . -name 'luci-theme-argon' -o -name 'mentohust' -o -name 'luci-app-netdata' | xargs -i rm -rf {}
