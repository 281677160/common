...
echo "DEFAULT_PATH=${GITHUB_WORKSPACE}/openwrt/package/mycustom/auto-scripts/files/99-first-run" >> ${GITHUB_ENV}
...
gitsvn https://github.com/281677160/common/tree/main/mycustom ${HOME_PATH}/package/mycustom
