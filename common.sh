...
svn co https://github.com/immortalwrt/packages/tree/openwrt-18.06/net/{v2ray-core,v2ray-plugin,xray-core,xray-plugin,brook,hysteria,trojan-go} package/luci-app-passwall
