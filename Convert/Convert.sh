...
cp -Rf SourceCode package/emortal/autocore/files/arm/rpcd_10_system.js > /dev/null 2>&1
cp -Rf SourceCode package/emortal/autocore/files/x86/rpcd_10_system.js > /dev/null 2>&1
chmod 664 feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js
chmod 664 package/emortal/autocore/files/arm/rpcd_10_system.js > /dev/null 2>&1
chmod 664 package/emortal/autocore/files/x86/rpcd_10_system.js > /dev/null 2>&1
